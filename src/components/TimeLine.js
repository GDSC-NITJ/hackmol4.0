...
<h1 className="justify-center h-1/2 text-black  text-3xl md:text-4xl font-extrabold items-center pb-4 text-center ">TimeLine</h1>
      <div class="border-l-2 border-yellow mt-10">
        <div class="transform transition shadow-3xl cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-blue text-white rounded-xl mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
          <div class="w-5 h-5 bg-blue absolute -left-10 transform -translate-x-2/4 top-12 rounded-full z-10 mt-2 md:mt-0"></div>

          <div class="w-10 h-1 bg-blue absolute top-14 -left-10 z-0"></div>
        ...
        <div class="transform transition shadow-3xl cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-green text-black rounded-xl mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
          ...
          <a href="#" class="text-center text-black hover:text-gray-300">Download materials</a>
        </div>
