...
let FAQ = function () {
    ...
    return (
        <div className="bg-orange flex flex-col  justify-center items-center  w-full py-10 md:py-20 ">
            ...
            <div className="bg-yellow shadow-3xl  min-h-[400px] mb-10 p-6 md:min-h-[300px] md:px-10 md:pt-10 md:pb-16  border w-11/12 sm:w-8/12 border-black  flex flex-col rounded-lg justify-items-center items-center">
