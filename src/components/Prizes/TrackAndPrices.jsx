...
function TrackAndPrices() {
  ...
  return (
    <div
      id="prizes"
      className="py-10 md:py-36  bg-[#D0A4FF] relative FF7B54 "
    >
      ...
      <div className=" px-8 py-10 flex gap-5 flex-wrap justify-center w-full ">
      
      <img src={grid.src} className="absolute bottom-0 border border-black border-[500] right-0 w-full height-full z-0"></img>
  
        <div className="border-2 border-black bg-[#ECB390] z-10 w-11/12 md:w-[380px]  flex flex-col items-center px-5 py-10  shadow-3xl rounded-xl font-bold  ">
          <h2 className="text-5xl mb-10 font-bold"> Filecoin </h2>
          <div className=" self-start mx-0">
        ...
        <div className="border-2 border-black bg-[#ECB390] z-10 w-11/12 md:w-[380px]  flex flex-col items-center px-5 py-10  shadow-3xl rounded-xl font-bold  ">
          <h2 className="text-5xl mb-10 font-bold"> Polygon </h2>
          <div className=" self-start mx-0">
            <p className=" font-normal text-lg mb-2">
        ...
        <div className="border-2 border-black bg-[#ECB390] z-10 w-11/12 md:w-[380px]  flex flex-col items-center px-5 py-10  shadow-3xl rounded-xl font-bold  ">
          <h2 className="text-5xl mb-10 font-bold"> Replit </h2>
          <div className=" self-start mx-0">
            <p className=" font-normal text-lg mb-2">
      ...
      <div className=" px-8 flex gap-5 justify-center w-full ">
      <div className="border-2 border-black bg-[#ECB390] z-10 w-11/12 md:w-[600px] flex flex-col items-center px-5 py-10  shadow-3xl rounded-xl font-bold  ">
        <h2 className="text-5xl mb-10 font-bold"> Solana </h2>
        <div className=" self-start mx-0">
          <p className=" font-normal text-lg mb-2">
            •<span className="font-bold"> young gun</span> - $USDC 100 for the best project beginners just
            starting out on Solana
          </p>
          <p className=" font-normal text-lg mb-2">
            • <span className="font-bold"> rising teknoking </span> - $USDC 250 for the best project that goes into
            depth, demonstrating higher-order code
          </p>
          <p className=" font-normal text-lg">
            • <span className="font-bold"> master glasseater </span> - $USDC 500 for the best advanced project that
